...
/* Ex.D
    Create a variable Me containing an object with the current information: Name = Your Name, Surname = Your Surname, Age = Your Age
*/
...
var programmingLanguages = ['Rust', 'Matlab'];
me.programming = programmingLanguages;
console.log('me:', me);
/* Ex.G 
...
console.log('me', me); // JS Functions
...
function WhoIsBigger(a, b) {
  a > b ? console.log(a, 'bigger') : console.log(b, 'bigger');
}
...
;
console.log(isThisAnEmail('suedsinani@protonmail.com'));
/* Ex.7
